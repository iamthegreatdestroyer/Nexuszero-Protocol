...
// env not used directly; std::env::var used inline
...
// that developer machines and CI without explicit timing support don't
// fail deterministically due to noisy environments.
proptest! {
    #[test]
    #[ignore]
    fn prop_ct_bytes_eq_timing_independent(a in proptest::collection::vec(any::<u8>(), 1..64)) {
        ...
        #[test]
        #[ignore]
        fn prop_ct_in_range_timing_independent(_val in 0u64..200, min in 0u64..100, max in 101u64..200) {
            // Ensure min < max
